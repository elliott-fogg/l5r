...
class CharacterDisplay extends CharacterInfo {
 ...
 //    }
    ...
    //     switch (stage_name) {
    //         case "restart": {
    //             console.log("New Character Setup Initiated");
    ...
    //             this.repopulate_family_select(this.family_id);
    //             this.repopulate_school_select(this.get_clan());
    //             break;
    //         }
    //         case "set_school": {
    //             console.log(`School Set: ${this.school_id}`);
    //             this.skill_choices = new Skill_Choices(this.school_id, this, 
    //                                                     "skill_choice_selects");
    //             break;
    //         }
    //         case "set_skill_choice": {
    //             console.log("All skills set");
    //             // All skill choices will have been set
    //             // Enable 'Generate Character' button
    //             var gen_char_btn = document.getElementById("gen_char_btn");
    //             gen_char_btn.disabled = false;
    //             gen_char_btn.onclick = function() {
    //                 this.set_char_creation_stage("generate_character");
    //             }.bind(this);
    //             break;
    //         }
    ...
    //             this.starting_skills = this.skill_choices.get_starting_skills();
    //             this.skills = this.starting_skills;
    ...
    //     } else {
    //         let default_text = `${this.get_family()} - ${this.get_clan()}`;
    //         create_select_default(sel, default_text, this.family_id);
    //     }
    ...
    //             var clan_schools = get_clan_schools(this.family_id);
    //             clan_schools.sort();
    //             for (let school of clan_schools) {
    //                 let option = document.createElement("option");
    //                 option.value = this.get_clan() + "_" + school;
    //                 option.label = school;
    ...
    //                                 return e !==this.get_clan()}.bind(this)).sort();
    //             }
    //             clan_names.unshift(this.get_clan());
