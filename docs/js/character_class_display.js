...
class CharacterDisplay extends CharacterInfo {
	...
	constructor(given_name, family_id, school_id, starting_skills, starting_traits) {
        ...
        var char_info_div = refresh_character_info(this);
    ...
    //     var div1 = create_info_div([["Name:", this.get_display_name()],
    //                                      ["Clan:", this.get_clan()],
    //                                      ["School:", this.get_display_school()],
    //                                      ["Rank:", this.calculate_rank()]]);

    //     var div2 = create_info_div([["Insight:", this.calculate_insight()],
    //                                      ["Remaining Exp:", this.experience],
    //                                      ["Total Exp:", this.total_experience]]);
    //     var add_exp_div = create_add_exp_div(this);
    ...
    //                 ring_type.appendChild(create_ring_button(this, ring_name));
    ...
    //                                         this, "trait", trait_name, true));
    //             trait_rank_div.appendChild(create_increment_button(
    //                                         this, "trait", trait_name, false));
    ...
    //     row.appendChild(create_skill_button(this, skill_name)); // Clickable Name
    ...
    //                             this, "skill", skill_name, true));
    //     rank_div.appendChild(create_increment_button(
    //                             this, "skill", skill_name, false));
    ...
    //         let btn = create_emphasis_button(this, skill_name, em);
    //         emphasis_div.appendChild(btn);
    //     })
    //     // Add Emphasis Select Box
    //     var emphasis_select = create_add_emphasis_list(this, skill_name);
    ...
    // refresh_display() {
    //     fill_trait_table(this);
    //     fill_skill_table(this);
    //     refresh_add_skill_dropdown(this);
    //     refresh_character_info(this);
    // }
